...
|--------|------------|-------|-------------|
| Total Time (hours) | 164.14 | 3.33 (Hybrid: 3.33 + Last-Resort: 0.00) | 97.97% |
| Sequential Time Equivalent | - | 16.08 | - |
| Time Savings from Parallelization | - | 12.75h (79.3%) | - |
| Driver Cost (EUR) | 2462.16 | 241.22 | 90.20% |
...
- Parallel hybrid operation time: 3.33 hours
- Truck travel time component (hybrid part): 11.81 hours
- Max cluster operation time (hybrid part): 1.83 hours
- Number of trucks (main hybrid): 11
- Number of clusters: 10
- **Total driver cost: 241.22 EUR**
...
**Netro System:**
- Hybrid parallel time: 3.3 hours (max across main truck routes to centroids + their cluster service time)
- Total Time: 3.3 hours
- Number of trucks (main hybrid): 11
- Total Driver Cost: €241.22 (sum of all driver hours for hybrid and last-resort)

## Financial Analysis

The Netro system saves **2220.93 EUR** in driver costs,
representing a 90.20% reduction compared to the traditional approach.
